    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-neutral-500 uppercase tracking-widest">
              {mode === 'ip'
                ? 'Input IPv4 address to correlate ARP and FDB tables.'
                : 'Input physical MAC address to find the access port.'}
            </p>
          </div>
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            >
              {loading ? <RefreshCcw className="w-4 h-4 animate-spin" /> : 'Trace_Now'}
            </button>
          </form>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {results.map((res, i) => (
          ...
          >
            {res.isMostLikely && (
              <div className="absolute -top-2.5 right-6 px-3 py-0.5 bg-white text-black text-[8px] font-black uppercase tracking-[0.3em] flex items-center gap-1.5 shadow-xl">
            ...
            <div className="p-6 flex flex-col lg:flex-row lg:items-center gap-8">
              <div className="flex-1 space-y-4">
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-neutral-500 font-mono ml-8">
                ...
                <div className="flex items-center gap-6 ml-8">
                  <div className="flex items-center gap-2">
                    <Hash className="w-3.5 h-3.5 text-neutral-700" />
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[9px] text-neutral-500 italic truncate max-w-[200px]">
              ...
              <div className="flex flex-col items-end gap-2 min-w-[180px]">
                ...
                <div className="text-[9px] text-neutral-700 font-bold uppercase">
                  Other MACs on port: {res.portMacCount}
                </div>
                <a
                  href={`/devices/${res.switchId}`}
                  className="mt-2 flex items-center gap-2 px-4 py-1.5 border border-white/10 text-[9px] font-bold uppercase hover:bg-white hover:text-black transition-all"
                >
